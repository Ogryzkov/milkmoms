...
Future<void> regenerateDonor() async {
  ...
  var a1 = await DatabaseHelper.instance.addDonor('Виктория','Петрова','1985-05-21','Луговая', '5', 1, 4, '5121649166602513','7968589626', 96612, '2021-06-22', '2022-06-22');
  var a2 = await DatabaseHelper.instance.addDonor('Анжелика','Иванова','1983-01-02','Оренбургская', '12', 1, 4, '5369909261118893','7913952237', 11542, '2021-03-22', '2022-03-22');
  var a3 = await DatabaseHelper.instance.addDonor('Елизавета','Зарица','1993-02-18','Советская', '61', 7, 5, '5121649010216999','7906261451', 16482, '2021-09-19', '2022-09-19');
  var a4 = await DatabaseHelper.instance.addDonor('Марьямна','Кугушева','1988-05-05','Пушкинская', '121', 2, 3, '5323570151567303','7975956572', 12516, '2021-01-05', '2022-01-05');
  var a5 = await DatabaseHelper.instance.addDonor('Римма','Койначёнока','1992-08-19','Уральская', '13', 1, 5, '5404370884368695','7927845561', 19548, '2021-08-09', '2022-08-09');
  var a6 = await DatabaseHelper.instance.addDonor('Александра','Саблина','1990-05-16','Тютчева', '85', 4, 2, '5324207882403081','7990517003', 56848, '2021-02-01', '2022-02-01');
  var a7 = await DatabaseHelper.instance.addDonor('Ева','Базина','1994-01-10','Угольная', '4', 7, 1, '5315785609657320','7961943728', 13068, '2021-02-05', '2022-02-05');
  var a8 = await DatabaseHelper.instance.addDonor('Любовь','Невская','1990-05-19','Кривая', '18', 3, 5, '5315770813644132','7936494363', 51357, '2021-03-06', '2022-03-06');
  var a9 = await DatabaseHelper.instance.addDonor('Людмила','Кубышкина','1984-12-13','Володская', '103', 1, 5, '5324203222639401','7965040736', 51568, '2021-05-09', '2022-05-09');
  var a10 = await DatabaseHelper.instance.addDonor('Альбина','Ярная','1992-02-21','Нижняя', '89', 2, 3, '5127173678805849','7943927566', 46258, '2021-08-08', '2022-08-08');
  print(a10);
